	...
	<div class="navbar navbar-inverse">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			<ul class="nav navbar-nav">
			 ...
			 <p class="navbar-text" align="center" id="marqueeid">Welcome :<b>&nbsp;&nbsp;<c:if test = "${not empty userOfficialName1}">${userOfficialName1}</c:if>&nbsp;&nbsp;Login ID : &nbsp;${userName}</b><b><!-- Designation: -->&nbsp;,<c:if test = "${not empty userbdesignation}">&nbsp;&nbsp;${userbdesignation}</c:if></b>&nbsp;&nbsp;Branch :<b> ${BranchName}</b>&nbsp;&nbsp;<b>Date :</b> ${defaultDate}</p>
			<%-- <p class="navbar-text" ><b style="text-align: center;padding-left: 90px;font-size: 17px;">Kathmandu Upatyaka Khanepani Limited</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Welcome :&nbsp;&nbsp;<c:if test = "${not empty userOfficialName1}">${userOfficialName1}</c:if>,&nbsp;&nbsp;<c:if test ="${not empty userbdesignation}">${userbdesignation}</c:if>&nbsp;&nbsp;&nbsp;&nbsp;Branch :<b> ${BranchName}</b>&nbsp;&nbsp;Date :${defaultDate} </p> --%>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown dropdown-user">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						...
						<c:if test = "${logintype=='BRANCH'}">
						<li><a href="./downloadBLUserManual/download" target="_blank"><i class="icon-book3"></i>Billing User Manual</a></li>
						<li><a href="./downloadAbbreviationList/download" target="_blank"><i class="icon-file-empty2"></i>Abbreviation List</a></li>
						<li><a href="https://drive.google.com/file/d/0ByvJUveJEzUYUFRqYW1KVXRRTTg/view" target="_blank"><i class="icon-file-video2"></i>Printer Cleaning</a></li>
						</c:if>
						<li><a href="./userprofile"><i class="icon-cog5"></i> Change Password</a></li>
						<li><a href="./logoutpage"><i class="icon-switch2"></i> Logout</a></li>
					</ul>
				</li>
			</ul>
		</div>
...
<!-- Chat modal -->
		...
		#marqueeid {
		    ...
		    animation: anjum 17ss linear infinite;
