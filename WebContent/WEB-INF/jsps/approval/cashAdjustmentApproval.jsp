				...
				<div class="panel panel-flat">
					<div class="panel-body">
							...
							<fieldset class="content-group" > 
								<legend class="text-bold">Cash Adjustment Approval
								 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<div class="col-md-12" id="billApprovalId" style="display: none;">
							...
							<fieldset class="content-group">
								...
								<legend class="text-bold" style="font-size: 18px;">Cash Adjustment Approval - <font color="red"><span id="connectionidspan"></span></font></legend>
					...
					<div class="panel-body" style="overflow: scroll;">
							...
							<fieldset class="content-group" > 
								<legend class="text-bold">Cash Adjustment Approval (Approved & Rejected)
								 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<button type="button" class="btn btn-danger btn-ladda"  data-style="expand-right" data-spinner-size="20" onclick="return getPendingList();"><span class="ladda-label" >Get Bill Correction List</span></button>
...
$(document).ready(function(){   
	$('#umapprovals').show();
	$('#approvalModule').addClass('active');
});
