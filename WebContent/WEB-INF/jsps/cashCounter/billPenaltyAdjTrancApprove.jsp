...
<div class="panel panel-flat">
	<div class="panel-body" style="overflow: scroll;">
		...
		<form action="./billpenaltyAdjTrancApproveStatus" method="POST">
			...
			<fieldset class="content-group">
				<legend class="text-bold">
					BILL OR PENALTY ADJUSTMENT TRANSACTION APPROVAL
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script>
	$(document).ready(function() {
		...
		$('#arrearsPenaltyModuleTrancScreen').show();
		$('#arrearsPenaltyTrancModule').addClass('active');

		var activeMod = "${activeModulesNew}";
		var module = "Arrears/Penalty Transaction";
