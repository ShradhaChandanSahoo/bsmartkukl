...
<div class="panel panel-flat">
	<div class="panel-body" style="overflow: scroll;">
		...
		<form action="./billpenaltyAdjApproveStatus" method="POST">
...
$(document).ready(function()
	{
		...
		$('#arrearsPenaltyModuleScreen').show();
		$('#arrearsPenaltyModule').addClass('active');

		var activeMod = "${activeModulesNew}";
		var module = "Arrears/Penalty Adjustment";
