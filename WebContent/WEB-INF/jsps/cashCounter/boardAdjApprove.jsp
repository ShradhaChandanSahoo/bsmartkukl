...
<div class="panel panel-flat">
	<div class="panel-body" style="overflow: scroll;">
		...
		<form action="./boardAdjApproveStatus" method="POST">
...
<script>
	...
	$(document).ready(function() {
		...
		$('#boardAdjApproveModuleScreen').show();
		$('#boardAdjApproveModule').addClass('active');

		var activeMod = "${activeModulesNew}";
		var module = "Board Adjustment Approve";
				...
				.ajax({
					...
					success : function(response) {
						...
						for (var i = 0; i < response.length; i++) {
							...
							if (data.bill_adj_amount == null) {
								ConnectionData += "<td></td>";
							} else {
								ConnectionData += "<td>" + data.bill_adj_amount
										+ "</td>";
							}
							if (data.penalty_adj_amount == null) {
								ConnectionData += "<td></td>";
							} else {
								ConnectionData += "<td>"
										+ data.penalty_adj_amount + "</td>";
							}
							if (data.to_mon_year == null) {
								ConnectionData += "<td></td>";
							} else {
								ConnectionData += "<td>" + data.to_mon_year
										+ "</td>";
							}
							...
							if (data.submit_date == null) {
								...
								ConnectionData += "<td>" + data.submit_date
										+ "</td>";
							}
							if (data.trans_approve == null) {
								ConnectionData += "<td></td>";
							} else {
								ConnectionData += "<td>" + data.trans_approve
										+ "</td>";
							}
							if (data.trans_approve_date == null) {
								ConnectionData += "<td></td>";
							} else {
								ConnectionData += "<td>"
										+ data.trans_approve_date + "</td>";
							}
							if (data.approve_by == null) {
								ConnectionData += "<td></td>";
							} else {
								ConnectionData += "<td>" + data.approve_by
										+ "</td>";
							}
							if (data.approve_date == null) {
								ConnectionData += "<td></td>";
							} else {
								ConnectionData += "<td>" + data.approve_date
										+ "</td>";
							}
							if (data.approve_status == null) {
								ConnectionData += "<td></td>";
							} else {
								ConnectionData += "<td>" + data.approve_status
										+ "</td>";
							}
