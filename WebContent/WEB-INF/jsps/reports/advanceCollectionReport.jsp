					...
					<div class="pdf-page">
						<kendo:grid name="categoryGrid" pageable="true"
							...
							<kendo:grid-columns>
								...
								<kendo:grid-column title="Pipe" field="denoted_by" width="70px"
									filterable="true" groupFooterTemplate="Total :"
									...
									<kendo:dataSource-schema-model id="id">
										<kendo:dataSource-schema-model-fields>
											...
											<kendo:dataSource-schema-model-field name="advance_rebate"
												type="number" />
											<kendo:dataSource-schema-model-field name="closing_adv"
												type="number" />
	...
	function getData() {
		...
		if (yearnep == "") {
			...
			$
					.ajax({
						type : "GET",
						url : "./advanceCollectionReport/advanceCollectionReportRead",
						dataType : "JSON",
						async : false,
