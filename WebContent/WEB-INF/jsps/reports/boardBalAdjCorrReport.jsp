	...
	<div class="panel panel-flat">
		<div class="panel-body">
			<fieldset class="content-group">
				<legend class="text-bold">Board Balance Adjustment/Correction Report</legend>
				<div>
				<div class="col-md-3">
						<label>Type <font color="red">*</font></label>
						<select data-placeholder="Select" class="select"  id="con_category" name="con_category" required="required">
					...
					<div class="pdf-page">
						<kendo:grid name="categoryGrid" pageable="true"
							...
							<kendo:grid-columns>
								...
								<kendo:grid-column title="Board Adj/Crr Amt" field="board_Adj"
									width="100px" filterable="true" aggregates="sum"
									groupFooterTemplate="#: kendo.toString(sum, 'n2') #"
									footerTemplate="#:kendo.toString(board_Adj,'n2') #" />
									
									<kendo:grid-column title="Category Wise"
									field="con_catagory" width="90px" filterable="true"/>
									
								<kendo:grid-column title="Balance" field="mast_bal"
									width="100px" filterable="true" aggregates="sum"
									groupFooterTemplate="#: kendo.toString(sum, 'n2') #"
									footerTemplate="#:kendo.toString(mast_bal,'n2') #" />
								...
								<kendo:dataSource-schema>
									<kendo:dataSource-schema-model id="id">
										<kendo:dataSource-schema-model-fields>
											...
											<kendo:dataSource-schema-model-field name="board_Adj" type="number" />
											<kendo:dataSource-schema-model-field name="con_catagory" type="string" />
											<kendo:dataSource-schema-model-field name="mast_bal" type="number" />
	...
	function getData() {
		...
		if (yearnep == "") {
			...
			$
					.ajax({
						type : "GET",
						url : "./boardBalAdjCorrReportDetails",
						dataType : "JSON",
						async : false,
...
function clearButton(){
		...
		window.location.href="./boardBalAdjCorrReport";
	}
</script>
<style>
</style>