	...
	<div class="panel panel-flat">
		<div class="panel-body">
			<fieldset class="content-group">
				<legend class="text-bold">Board Daily Revenue Report</legend>
				<div class="row">
				...
				<div class="text-center">
					...
					<label>&nbsp;</label>
					<button type="button" class="btn bg-teal btn-ladda"
						onclick="return getBoardDailyRevenueData()" data-style="expand-right"
						data-spinner-size="20">
						<span class="ladda-label">Get Board Revenue Data</span>
					</button>
				</div>
			...
			<div class="wethear" style="overflow: scroll;">
				<fieldset class="content-group">
					<legend class="text-bold">Daily Board Revenue Report</legend>
...
<!--  ward_no,opening_arrears,water_charge,sw_charge,meter_rent,penalty,rebate,adv_payment,next_payment,arrear_balance -->
	...
	function printGrid() {
		...
		var htmlStart = '<!DOCTYPE html>'
				...
				+ '<head>'
				+ '<meta charset="utf-8" />'
				+ '<title>Daily Board Revenue Report</title>'
				...
				+ '<h2>'+branch+' kathmandu</h2><h3>Board Daily Revenue Report</h3>'
	...
	function getBoardDailyRevenueData() {
		var from_date = $("#fromDatenep").val();
		var to_date = $("#toDatenep").val();
		if (from_date == "") {
		...
		if (startDate > endDate) {
			...
			$.ajax({
				type : "GET",
				url : "./revenueReport/dailyBoardRevenueReportRead",
				dataType : "JSON",
				async : false,
				data : {
					from_date : from_date,
...
function clearButton(){
		...
		window.location.href="./boardRevenueReport";
	}
