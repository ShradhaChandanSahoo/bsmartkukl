	...
	<div class="panel panel-flat">
		<div class="panel-body">
			<fieldset class="content-group">
				<legend class="text-bold">Board Sales Report</legend>
				<div class="row">
		...
		<%--  <kendo:grid-excel allPages="true" fileName="Kendo UI Grid Export.xlsx" filterable="true"  /> footerTemplate="<span id='sumTotal_Earnings'></span>"--%>
			<kendo:grid-editable mode="popup" confirmation="Are you sure you want to remove this item?" />
				<kendo:grid-columns>
					...
					<kendo:grid-column title="Ward No" field="wardNo" width="80px" filterable="true"  groupFooterTemplate="Total :" footerTemplate="Grand&nbsp;Tot:" />
					...
					<kendo:grid-column title="Paid" field="paid" width="100px" filterable="true" aggregates="sum" groupFooterTemplate="#: kendo.toString(sum, 'n2') #" footerTemplate="#:kendo.toString(paid,'n2') #" />
								...
								<kendo:dataSource-schema>
									<kendo:dataSource-schema-model id="id">
										<kendo:dataSource-schema-model-fields>
											...
											<kendo:dataSource-schema-model-field name="wardNo" type="string" />
											<kendo:dataSource-schema-model-field name="openingBal" type="number" />
											<kendo:dataSource-schema-model-field name="paid" type="number" />
...
<!--  ward_no,opening_arrears,water_charge,sw_charge,meter_rent,penalty,rebate,adv_payment,next_payment,arrear_balance -->
	...
	function printGrid() {
		...
		var htmlStart = '<!DOCTYPE html>'
				...
				+ '<head>'
				+ '<meta charset="utf-8" />'
				+ '<title>Board Sales Report</title>'
				...
				+ '<h2>'+branch+' kathmandu</h2><h3>Board Sales Report</h3>'
				+ '<h4>From :&nbsp;&nbsp;' + frm
				+ '&nbsp;&nbsp;&nbsp;To :&nbsp;&nbsp;' + to + '&nbsp;&nbsp;</h4></center>';
	...
	function getDailyRevenueData() {
		...
		/* if (category == "" || category ==null) {
			...
			$.ajax({
				type : "GET",
				url : "./boardSalesReport/boardSalesReportRead",
				dataType : "JSON",
				async : false,
				data : {
					from_date : from_date,
...
function clearButton(){
		...
		window.location.href="./boardSalesReport";
	}
