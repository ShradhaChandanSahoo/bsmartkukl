	...
	<div class="panel panel-flat">
		<div class="panel-body">
			<fieldset class="content-group">
				<legend class="text-bold">Category Collection Report</legend>
				<div class="row">
		...
		<%--  <kendo:grid-excel allPages="true" fileName="Kendo UI Grid Export.xlsx" filterable="true"  /> footerTemplate="<span id='sumTotal_Earnings'></span>"--%>
			<kendo:grid-editable mode="popup" confirmation="Are you sure you want to remove this item?" />
				<kendo:grid-columns>
				 	<kendo:grid-column title="SlNo" field="slNo" width="40px" filterable="true" groupFooterTemplate="Total :" footerTemplate="Grand&nbsp;Tot:" />
					<kendo:grid-column title="Category" field="category" width="75px" filterable="true"  />
					<kendo:grid-column title="Total Bill Amt" field="currentRevenue" width="100px" filterable="true" aggregates="sum" groupFooterTemplate="#: kendo.toString(sum, 'n2') #" footerTemplate="#:kendo.toString(currentRevenue,'n2') #" />
					<kendo:grid-column title="Paid Bill Amt" field="paidBilling" width="100px" filterable="true" aggregates="sum" groupFooterTemplate="#: kendo.toString(sum, 'n2') #" footerTemplate="#:kendo.toString(paidBilling,'n2') #" />
					<kendo:grid-column title="Current Penalty" field="currentPenalty" width="100px" filterable="true" aggregates="sum" groupFooterTemplate="#: kendo.toString(sum, 'n2') #" footerTemplate="#:kendo.toString(currentPenalty,'n2') #" />
					<kendo:grid-column title="KUKL" field="pamount" width="95px" filterable="true" aggregates="sum" groupFooterTemplate="#: kendo.toString(sum, 'n2') #" footerTemplate="#:kendo.toString(pamount,'n2') #" />
					<kendo:grid-column title="BOARD" field="pamountBoard" width="95px" filterable="true" aggregates="sum" groupFooterTemplate="#: kendo.toString(sum, 'n2') #" footerTemplate="#:kendo.toString(pamountBoard,'n2') #" />
								...
								<kendo:dataSource-schema>
									<kendo:dataSource-schema-model id="id">
										<kendo:dataSource-schema-model-fields>
											...
											<kendo:dataSource-schema-model-field name="currentRevenue" type="number" />
											<kendo:dataSource-schema-model-field name="currentPenalty" type="number" />
											<kendo:dataSource-schema-model-field name="paidBilling" type="number" />
											<kendo:dataSource-schema-model-field name="pamount" type="number" />
											<kendo:dataSource-schema-model-field name="pamountBoard" type="number" />
...
<!--  ward_no,opening_arrears,water_charge,sw_charge,meter_rent,penalty,rebate,adv_payment,next_payment,arrear_balance -->
	...
	function printGrid() {
		...
		var htmlStart = '<!DOCTYPE html>'
				...
				+ '<h2>'+branch+' kathmandu</h2><h3>Category Collection Report</h3>'
				+ '<h4>From :&nbsp;&nbsp;' + frm
				+ '&nbsp;&nbsp;&nbsp;To :&nbsp;&nbsp;' + to + '&nbsp;&nbsp;</h4></center>';
	...
	function getDailyRevenueData() {
		...
		/* if (category == "" || category ==null) {
			...
			$.ajax({
				type : "GET",
				url : "./categoryCollectionReport/categoryCollectionReportRead",
				dataType : "JSON",
				async : false,
				data : {
					from_date : from_date,
...
function clearButton(){
		...
		window.location.href="./categoryCollectionReport";
	}
