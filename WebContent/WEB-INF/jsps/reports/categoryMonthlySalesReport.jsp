	...
	<div class="panel panel-flat">
		<div class="panel-body">
			<fieldset class="content-group">
				<legend class="text-bold">Category Monthly Sales Report</legend>
				<div>
					<div class="col-md-3">
				...
				<div class="form-group col-md-3">
				   ...
				   <div class="form-group col-md-3">
						...
						<select data-placeholder="Select" class="select"
			...
			<div class="wethear" style="overflow: scroll;">
				<fieldset class="content-group">
					<legend class="text-bold">Category Monthly Sales Summary Report</legend>
...
<script>
	...
	function printGrid() {
		...
		var htmlStart = '<!DOCTYPE html>'
				...
				+ '<head>'
				+ '<meta charset="utf-8" />'
				+ '<title>Category Monthly Sales Summary Report</title>'
				...
				+ '<h2>' + branch
				+ ' kathmandu</h2><h3>Category Monthly Sales Summary Report</h3>'
				+ '<h4>From :&nbsp;&nbsp;' + mnyr
				+ '&nbsp;&nbsp;&nbsp;To :&nbsp;&nbsp;' + mnyr + '&nbsp;&nbsp;Category :&nbsp;&nbsp;' + con_category +'</h4></center>';
	...
	function getData() {
		...
		if (yearnep == "") {
			...
			$
					.ajax({
						type : "GET",
						url : "./newMonthlySalesCategory/monthlySalesReadData",
						dataType : "JSON",
						async : false,
...
function clearButton(){
		...
		window.location.href="./categoryMonthlySalesReport";
	}
</script>
<style>
</style>