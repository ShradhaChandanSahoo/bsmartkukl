	...
	<div class="panel panel-flat">
		<div class="panel-body">
			<fieldset class="content-group">
				<legend class="text-bold">Con Type Change Report</legend>
				<div class="row">
		...
		<%--  <kendo:grid-excel allPages="true" fileName="Kendo UI Grid Export.xlsx" filterable="true"  /> footerTemplate="<span id='sumTotal_Earnings'></span>"--%>
			<kendo:grid-editable mode="popup" confirmation="Are you sure you want to remove this item?" />
				<kendo:grid-columns>
					...
					<kendo:grid-column title="Connection No" field="con_no" width="85px" filterable="true"  />
					<kendo:grid-column title="Name" field="name" width="180px" filterable="true"  />
					<kendo:grid-column title="Area" field="area" width="80px" filterable="true"  />
					<kendo:grid-column title="New Area" field="new_area" width="80px" filterable="true"  />
					<kendo:grid-column title="Pipe" field="pipe_size" width="80px" filterable="true"  />
					<kendo:grid-column title="New Pipe" field="new_pipe_size" width="80px" filterable="true"  />
					<kendo:grid-column title="Con Type" field="con_type" width="90px" filterable="true"  />
					<kendo:grid-column title="Con Type(N)" field="new_con_type" width="90px" filterable="true"  />
					<kendo:grid-column title="Con Status" field="con_status" width="90px" filterable="true"  />
					<kendo:grid-column title="Con Status(N)" field="new_con_status" width="90px" filterable="true"  />
					<kendo:grid-column title="Remarks" field="remarks" width="150px" filterable="true"  />
								...
								<kendo:dataSource-schema>
									<kendo:dataSource-schema-model id="id">
										<kendo:dataSource-schema-model-fields>
											...
											<kendo:dataSource-schema-model-field name="new_area" type="string" />
											<kendo:dataSource-schema-model-field name="pipe_size" type="string" />
											<kendo:dataSource-schema-model-field name="new_pipe_size" type="string" />
											<kendo:dataSource-schema-model-field name="con_type" type="string" />
											<kendo:dataSource-schema-model-field name="new_con_type" type="string" />
											<kendo:dataSource-schema-model-field name="con_status" type="string" />
											<kendo:dataSource-schema-model-field name="new_con_status" type="string" />
...
<!--  ward_no,opening_arrears,water_charge,sw_charge,meter_rent,penalty,rebate,adv_payment,next_payment,arrear_balance -->
	...
	function printGrid() {
		...
		var htmlStart = '<!DOCTYPE html>'
				...
				+ '<head>'
				+ '<meta charset="utf-8" />'
				+ '<title>Connection Type Change Report</title>'
				...
				+ '<h2>'+branch+' kathmandu</h2><h3>Connection Type Change Report</h3>'
				+ '<h4>From :&nbsp;&nbsp;' + frm
				+ '&nbsp;&nbsp;&nbsp;To :&nbsp;&nbsp;' + to + '&nbsp;&nbsp;</h4></center>';
	...
	function getReport() {
		...
		/* if (category == "" || category ==null) {
			...
			$.ajax({
				type : "GET",
				url : "./conTypeChngReport/conTypeChngReportRead",
				dataType : "JSON",
				async : false,
				data : {
					from_date : from_date,
...
function clearButton(){
		...
		window.location.href="./conTypeChngReport";
	}
