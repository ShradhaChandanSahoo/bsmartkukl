						...
						<kendo:grid name="categoryGrid" pageable="true"
							...
							<kendo:grid-columns>
								...
								<kendo:grid-column title="WC" field="water_charges"
									...
									groupFooterTemplate="#: kendo.toString(sum, 'n2') #"
									footerTemplate="#:kendo.toString(water_charges, 'n2','0.00') #" />
								<kendo:grid-column title="SWC" field="sw_charges"
									filterable="true" width="100px" aggregates="sum"
									groupFooterTemplate="#: kendo.toString(sum, 'n2') #"
									footerTemplate="#:kendo.toString(sw_charges, 'n2','0.00') #" />
								<kendo:grid-column title="MR" field="meter_rent"
									filterable="true" width="80px" aggregates="sum"
									groupFooterTemplate="#: kendo.toString(sum, 'n2') #"
									footerTemplate="#:kendo.toString(meter_rent, 'n2','0.00') #" />
									...
									<kendo:dataSource-schema-model id="id">
										<kendo:dataSource-schema-model-fields>
											...
											<kendo:dataSource-schema-model-field name="sw_charges"
												type="number" />
											<kendo:dataSource-schema-model-field name="meter_rent"
												type="number" />
											<kendo:dataSource-schema-model-field
												name="miscellaneous_cost" type="number" />
	...
	function getData() {
		...
		if (startDate > endDate) {
			...
			$
					.ajax({
						type : "GET",
						url : "./detailedCashCollReport/detailedCashCollReportReadData",
						dataType : "JSON",
						async : false,
						data : {
							from_date : from_date,
