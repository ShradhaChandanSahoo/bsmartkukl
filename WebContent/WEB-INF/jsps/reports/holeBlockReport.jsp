...
<c:url value="/holeBlockReport/holeBlockReportReadData" var="readCategoryUrl"/>
	...
	<div class="panel panel-flat">
		...
		<fieldset class="content-group">
				<legend class="text-bold">Hole Block Report</legend> 
		<div>
			
				<div class="col-md-4">
												<div class="form-group">
												<label>Connection Status&nbsp;<font color="red">*</font></label> 
												<select class="select" name="con_status" id="con_status"> 
												...
												<option value="Temporary" data-icon="icon-git-branch">Temporary</option>
												<option value="Defaulter" data-icon="icon-git-branch">Defaulter</option>
												<option value="Permanent" data-icon="icon-git-branch">Permanent</option>
	 ...
	 <kendo:grid-editable mode="popup" confirmation="Are you sure you want to remove this item?" />
	   <kendo:grid-columns>
	      <kendo:grid-column title="Sl.No" field="slNo" width="80px" filterable="true"/>    
	       	...
	       	<kendo:grid-column title="Connection Type" field="con_type" width="160px" filterable="true"/>
	       	<kendo:grid-column title="Pipe Size" field="pipe_size" width="110px" filterable="true"/>
	       	<kendo:grid-column title="Connection Status" field="con_status" width="160px" filterable="true"/>
	   </kendo:grid-columns>
...
function onChange(arg) {
	...
	'<!DOCTYPE html>'
				...
				+ '<h2>' + branch + ' kathmandu</h2><h3>Hole Block Report</h3>'
	...
	function getData() {
		...
		if (con_status == "") {
			...
			$
					.ajax({
						type : "GET",
						url : "./holeBlockReport/holeBlockReportReadData/"
								+ con_status,
						dataType : "JSON",
						async : false,
