	...
	<div class="panel panel-flat">
		<div class="panel-body">
			<fieldset class="content-group">
				<legend class="text-bold">Meter Changed Details Report
			...
			<div class="col-md-4">
				<div class="form-group" style="padding-top: 27px;">
					...
					<span class="ladda-label">Get Meter Changed Details Report</span></button>
	                           </div>
			</div>
 ...
 <%--  <kendo:grid-excel allPages="true" fileName="Kendo UI Grid Export.xlsx" filterable="true"  /> footerTemplate="<span id='sumTotal_Earnings'></span>"--%>
	 <kendo:grid-editable mode="popup" confirmation="Are you sure you want to remove this item?" />
	   <kendo:grid-columns>
	       	...
	       	<kendo:grid-column title="Ledg No" field="ledgno" width="70px" filterable="true"/>      
	       	<kendo:grid-column title="Folio No" field="folio" width="70px" filterable="true"/>    
	       	<kendo:grid-column title="Final Reading" field="fr" width="80px" filterable="true"/>    
	       	<kendo:grid-column title="Initial Reading" field="ir" width="70px" filterable="true"/>
	       	<kendo:grid-column title="Old Meter No" field="oldmeterno" width="80px" filterable="true"/>
	       	<kendo:grid-column title="New Meter No" field="newmeterno" width="60px" filterable="true"/>
	       	 <kendo:grid-column title="Change By" field="username" width="130px" filterable="true"/>
	       <kendo:grid-column title="Change Date" field="datestamp" width="130px" filterable="true"/> 
	   ...
	   <kendo:dataSource pageSize="100" >
		 ...
		 <kendo:dataSource-schema>
			<kendo:dataSource-schema-model id="id">
			  ...
			  <kendo:dataSource-schema-model-field name="ledgno" type="string"/> 
			   <kendo:dataSource-schema-model-field name="folio" type="string"/> 
			  <kendo:dataSource-schema-model-field name="fr" type="number"/>
			  <kendo:dataSource-schema-model-field name="ir" type="number"/>
			  <kendo:dataSource-schema-model-field name="oldmeterno" type="string"/>
			  <kendo:dataSource-schema-model-field name="newmeterno" type="string"/>
			   <kendo:dataSource-schema-model-field name="username" type="string"/>
			   <kendo:dataSource-schema-model-field name="datestamp" type="string"/> 
			  </kendo:dataSource-schema-model-fields>
...
function onChange(arg) {
	...
	'<!DOCTYPE html>'
				...
				+ '<head>'
				+ '<meta charset="utf-8" />'
				+ '<title>Meter Change Details Report</title>'
				...
				+ '<h2>' + branch
				+ ' kathmandu</h2><h3>Meter Change Details Report</h3>';
