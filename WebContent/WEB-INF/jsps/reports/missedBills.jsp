	...
	<div class="panel panel-flat">
		<div class="panel-body">
			...
			<fieldset class="content-group">
				<legend class="text-bold">Missed Bills Report</legend>
				<div>
					<div class="col-md-3">
					...
					<div class="col-md-6">
						<div class="form-group" style="padding-top: 27px;">
							...
							<button type="button" class="btn bg-teal btn-ladda"
								...
								<span class="ladda-label">Pending Reading Entry</span>
							</button>
							
							<button type="button" class="btn bg-teal btn-ladda"
								onclick="return getData1()" data-style="expand-right"
								data-spinner-size="20">
								<span class="ladda-label">Get Missed Customers</span>
							</button>
			...
			<div class="wethear" style="overflow: scroll;">
	       	...
	       	<kendo:grid-column title="element" field="" width="130px" filterable="true"/> 
								...
								<kendo:grid-column title="Sl. No" field="slNo" width="80px"
									filterable="true" />
								<kendo:grid-column title="Conn No" field="ConNo" width="110px"
									filterable="true"/>
								<kendo:grid-column title="Name" field="Name"
									width="220px" filterable="true" />
								<kendo:grid-column title="Ward No" field="WardNo" width="100px"
									filterable="true"/>
								<kendo:grid-column title="Reading Day" field="Rday" width="100px"
									filterable="true"/>
								<kendo:grid-column title="Area" field="Area" width="110px"
									filterable="true"/>
								<kendo:grid-column title="Pipe Size" field="Pipe" width="100px"
									filterable="true"/>
								<kendo:grid-column title="Con Type" field="ConType" width="110px"
									filterable="true"/>
							</kendo:grid-columns>
									...
									<kendo:dataSource-schema-model id="id">
										<kendo:dataSource-schema-model-fields>
											...
											<kendo:dataSource-schema-model-field name="WardNo"
												type="number" />
											<kendo:dataSource-schema-model-field name="Rday"
												type="number" />
											<kendo:dataSource-schema-model-field name="Area"
												type="string" />
											<kendo:dataSource-schema-model-field name="Pipe"
												type="number" />
...
<script>
	...
	function printGrid() {
		...
		var htmlStart = '<!DOCTYPE html>'
				...
				+ '<head>'
				+ '<meta charset="utf-8" />'
				+ '<title>Missed Bills Report</title>'
				...
				+ '<h2>'+branch+' kathmandu</h2><h3>Missed Bills Report</h3>'
	...
	function getData() {
		...
		if (month == ""|| month==null) {
			...
			$
					.ajax({
						type : "GET",
						url : "./missedBillsReport/missedBillsReportRead",
						dataType : "JSON",
						async : false,
						data : {
							yearnep : yearnep,
	...
	function getData1() {
		...
		if (month == ""|| month==null) {
			...
			$
					.ajax({
						type : "GET",
						url : "./missedBillsReport/missedBillsReportRead2",
						dataType : "JSON",
						async : false,
						data : {
							yearnep : yearnep,
