	...
	<div class="panel panel-flat">
		<div class="panel-body">
			<fieldset class="content-group">
				<legend class="text-bold">New Connection Report</legend>
				<div class="row">
					...
					<div class="form-group col-md-3">
					 ...
					 <div class="form-group col-md-3">
						<label>New Connection From <font color="red">*</font></label> 
						...
						<option value="" data-icon="icon-git-branch">Select
							...
							<option value="1" data-icon="icon-git-branch">MASTER</option>
							<option value="2" data-icon="icon-git-commit">NEW CONNECTION</option>
				...
				<div class="text-center">
					...
					<button type="button" class="btn bg-teal btn-ladda"
						...
						<span class="ladda-label">Get New Connection Data</span>
					</button>
				</div>
			...
			<div class="wethear" style="overflow: scroll;">
				<fieldset class="content-group">
					<legend class="text-bold">New Connection Report Details</legend>
		...
		<%--  <kendo:grid-excel allPages="true" fileName="Kendo UI Grid Export.xlsx" filterable="true"  /> footerTemplate="<span id='sumTotal_Earnings'></span>"--%>
			<kendo:grid-editable mode="popup" confirmation="Are you sure you want to remove this item?" />
				<kendo:grid-columns>
					...
					<kendo:grid-column title="Name" field="name" width="100px" filterable="true"  />
					<kendo:grid-column title="Area No" field="areaNo" width="100px" filterable="true"  />
								...
								<kendo:dataSource-schema>
									<kendo:dataSource-schema-model id="id">
										<kendo:dataSource-schema-model-fields>
											...
											<kendo:dataSource-schema-model-field name="name" type="number" />
											<kendo:dataSource-schema-model-field name="areaNo" type="number" />
	...
	function getNewConnDetails() {
		...
		if (startDate > endDate) {
		 ...
		 if (concategory == "" || concategory ==null) {
			...
			$.ajax({
				type : "GET",
				url : "./newConnectionReportDetails",
				dataType : "JSON",
				async : false,
				data : {
					from_date : from_date,
