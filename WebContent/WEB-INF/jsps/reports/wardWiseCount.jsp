...
<c:url value="/wardWiseCount/consumerCountReport1" var="readCategoryUrl"/>
	...
	<div class="panel panel-flat">
		<div class="panel-body">
			<fieldset class="content-group">
				<legend class="text-bold">Ward Wise Customer Count
			...
			<div class="col-md-4">
				<div class="form-group" style="padding-top: 27px;">
					...
					<span class="ladda-label">Get Ward Report</span></button>
	                           </div>
			</div>
 ...
 <%--  <kendo:grid-excel allPages="true" fileName="Kendo UI Grid Export.xlsx" filterable="true"  /> footerTemplate="<span id='sumTotal_Earnings'></span>"--%>
	 <kendo:grid-editable mode="popup" confirmation="Are you sure you want to remove this item?" />
	   <kendo:grid-columns>
	       	...
	       	<kendo:grid-column title="Sl.No" field="slNo" width="200px" filterable="true" groupFooterTemplate="Total :" footerTemplate="Grand&nbsp;Total:"/>    
	       	<kendo:grid-column title="Ward No" field="ward_no" width="200px" filterable="true"/> 
	       		<kendo:grid-column title="Reading Day" field="reading_day" width="200px" filterable="true"/>    
	       	<kendo:grid-column title="Count" field="countno" width="200px" filterable="true" aggregates="sum" groupFooterTemplate="#: kendo.toString(sum, 'n2') #" footerTemplate="#:kendo.toString(countno, 'n2','0.00') #"/>    
	   ...
	   <kendo:dataSource pageSize="100" >
		 ...
		 <kendo:dataSource-schema>
			<kendo:dataSource-schema-model id="id">
			  ...
			  <kendo:dataSource-schema-model-field name="reading_day" type="string"/>
			  <kendo:dataSource-schema-model-field name="countno" type="number"/> 
...
function onChange(arg) {
	...
	'<!DOCTYPE html>'
				...
				+ '<h2>' + branch
				+ ' kathmandu</h2><h3>WARD WISE CUSTOMER COUNT</h3>';
	...
	function getData() {
		...
		$.ajax({
			type : "GET",
			url : "./wardWiseCount/consumerCountReport",
			dataType : "JSON",
			async : false,
