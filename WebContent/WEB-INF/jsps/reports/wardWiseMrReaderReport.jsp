	...
	<div class="panel panel-flat">
		<div class="panel-body">
			...
			<fieldset class="content-group">
				<legend class="text-bold">Ward Wise Meter Reader Report</legend>
				<div>
					<div class="col-md-3">
			...
			<div class="wethear" style="overflow: scroll;">
	       	...
	       	<kendo:grid-column title="element" field="" width="130px" filterable="true"/> 
								...
								<kendo:grid-column title="MR Name" field="mrName" width="110px"
									filterable="true"/>
								<kendo:grid-column title="Count" field="obcount" width="110px"
									filterable="true" aggregates="sum"
									groupFooterTemplate="#: kendo.toString(sum, 'n2') #"
									footerTemplate="#:kendo.toString(obcount, 'n2','0.00') #"/>
							</kendo:grid-columns>
									...
									<kendo:dataSource-schema-model id="id">
										<kendo:dataSource-schema-model-fields>
											...
											<kendo:dataSource-schema-model-field name="mrName"
												type="number" />
											<kendo:dataSource-schema-model-field name="obcount"
												type="number" />
...
<script>
	...
	function dataBound(e) {
		...
		for (var i = 0; i < data.length; i++) {
			sa = sa + data[i].sa;
			tha = tha + data[i].tha;
			obcount = obcount + data[i].obcount;
		}
	}
	...
	function printGrid() {
		...
		var htmlStart = '<!DOCTYPE html>'
				...
				+ '<head>'
				+ '<meta charset="utf-8" />'
				+ '<title>Ward Wise Meter Reader Report</title>'
				...
				+ '<h2>'+branch+' kathmandu</h2><h3>Ward Wise Meter Reader Report</h3>'
	...
	function getData() {
		...
		if (month == ""|| month==null) {
			...
			$
					.ajax({
						type : "GET",
						url : "./wardWiseMrReaderReport/wardWiseMrReaderReportRead",
						dataType : "JSON",
						async : false,
						data : {
							yearnep : yearnep,
...
function clearButton(){
		...
		window.location.href="./wardWiseMrReaderReport";
	}
</script>
<style>
</style>