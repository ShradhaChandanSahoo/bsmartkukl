...
public class DataSourceRequest {
    ...
    public List<?>  group(List<?> items, final Session session, final Class<?> clazz) {
        ...
        if (group != null && !group.isEmpty()) {
            ...
            try {
				result = groupBy(items, group, clazz, session, new ArrayList<SimpleExpression>());
    ...
    public DataSourceResult toDataSourceResult(Criteria criteria, Class<?> clazz,Session session) {
